var activeMissions = [
{start:'1.27991, 103.84794',
finish:'1.27991, 103.84794', },

{start:'1.27832, 103.84945',
finish:'1.27405, 103.84677', },

{start:'1.27695, 103.85415',
finish:'1.27587, 103.85819', },

{start:'1.28810, 103.85428',
finish:'1.29707, 103.85857', },

{start:'1.27385, 103.84115',
finish:'1.27514, 103.84604', },
];
...
function startAnimation() {
        ...
        // map.addOverlay(poly2);
        setTimeout("animate(500)",2000);  // Allow time for the initial map display
}
...
function startAnimation2() {
        ...
        // map.addOverlay(poly2);
        setTimeout("animate2(540)",2000);  // Allow time for the initial map display
}
...
var droneInfoWindowContent1 = '<div class="droneInfoWindow"><div class="droneAttribute">'+
'Drone:Parrot AR Drone<br/>'+
'FB HACK DEMO'+
'</div></div>';

var droneInfoWindowContent2 = '<div class="droneInfoWindow"><div class="droneAttribute">'+
'Drone:PhantomDJI<br/>'+
'Area Sweep'+
'</div></div>';

var droneInfoWindowContent3 = '<div class="droneInfoWindow"><div class="droneAttribute">'+
'Drone:Arducopter<br/>'+
'Road Inspectiony'+
'</div></div>';

var droneInfoWindowContent4 = '<div class="droneInfoWindow"><div class="droneAttribute">'+
'Drone:Crazyflie<br/>'+
'Search & Rescue'+
'</div></div>';

var droneInfoWindowContent5 = '<div class="droneInfoWindow"><div class="droneAttribute">'+
'Drone:PhantomDJI<br/>'+
'Area Sweep'+
'</div></div>';

var droneInfoWindowOptions1 = {disableAutoPan: false,
  alignBottom: true,
  closeBoxURL: "",
  ...
  content:droneInfoWindowContent1,
  pane: "mapPane"

  };

  var droneInfoWindowOptions2 = {disableAutoPan: false,
  alignBottom: true,
  closeBoxURL: "",
  pixelOffset: new google.maps.Size(0, -40),
  boxStyle: { 
  ...
  maxWidth: 0,  // no max
  infoBoxClearance: new google.maps.Size(1, 1),
  content:droneInfoWindowContent2,
  pane: "mapPane"

  };

var droneInfoWindowOptions3 = {disableAutoPan: false,
  alignBottom: true,
  closeBoxURL: "",
  pixelOffset: new google.maps.Size(0, -40),
  boxStyle: { 
  ...
  maxWidth: 0,  // no max
  infoBoxClearance: new google.maps.Size(1, 1),
  content:droneInfoWindowContent3,
  pane: "mapPane"

  };

var droneInfoWindowOptions4 = {disableAutoPan: false,
  alignBottom: true,
  closeBoxURL: "",
  pixelOffset: new google.maps.Size(0, -40),
  boxStyle: { 
  ...
  maxWidth: 0,  // no max
  infoBoxClearance: new google.maps.Size(1, 1),
  content:droneInfoWindowContent4,
  pane: "mapPane"

  };

  var droneInfoWindowOptions5 = {disableAutoPan: false,
  alignBottom: true,
  closeBoxURL: "",
  pixelOffset: new google.maps.Size(0, -40),
  boxStyle: { 
  ...
  maxWidth: 0,  // no max
  infoBoxClearance: new google.maps.Size(1, 1),
  content:droneInfoWindowContent5,
  pane: "mapPane"

  };

  var droneInfoWindow1 = new InfoBox(droneInfoWindowOptions1);
  droneInfoWindow1.open(map, marker);
  var droneInfoWindow2 = new InfoBox(droneInfoWindowOptions2);
  droneInfoWindow2.open(map, marker2);
  var droneInfoWindow3 = new InfoBox(droneInfoWindowOptions3);
  droneInfoWindow3.open(map, marker3);
  var droneInfoWindow4 = new InfoBox(droneInfoWindowOptions4);
  droneInfoWindow4.open(map, marker4);
  var droneInfoWindow5 = new InfoBox(droneInfoWindowOptions5);
  droneInfoWindow5.open(map, marker5);
});
